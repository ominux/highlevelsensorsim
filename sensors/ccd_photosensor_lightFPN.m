...
ccd.noise.PRNU.noisematrix = ccd_FPN_models(ccd, ccd.sensor_size(1), ccd.sensor_size(2), 'pixel', ccd.noise.PRNU.model, ccd.noise.PRNU.parameters); %% getting the matrix for the PRNU
